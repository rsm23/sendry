...
export default function LoginPage() {
  ...
  return <main className="grid min-h-svh bg-background lg:grid-cols-[1.1fr_0.9fr]">
    ...
    <section className="relative flex items-center justify-center p-5 sm:p-10">
      <PreferencesMenu className="absolute end-4 top-4" />
