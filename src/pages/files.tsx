...
export default function FilesPage() {
  ...
  const [crumbs, setCrumbs] = useState<Crumb[]>(() => {
    ...
    return parentId ? [{ id: null, name: 'All files' }, { id: parentId, name: 'Selected folder' }] : [{ id: null, name: 'All files' }]
  })
