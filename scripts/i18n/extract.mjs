...
const messages = new Set([
  ...
  'Choose or drag content into your email.', 'Drop content here', 'Select and reorder the email structure.',
  'Edit the selected element and email settings.',
  'All files', 'File library', 'File location', 'Files could not be uploaded', 'Loading files…',
  'Files could not be loaded', 'No files in this folder', 'No files were uploaded. Check the allowed file types.',
  'No matching files', 'Open folder', 'Search files', 'Try a different search.', 'Try again',
  'Upload a file here or return to another folder.', 'Upload files', 'Uploading…',
  'file selected', 'files selected', '{count} file uploaded', '{count} files uploaded',
